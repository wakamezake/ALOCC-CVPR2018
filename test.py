...
flags.DEFINE_integer("train_size", 100, "The size of train images 100")
...
flags.DEFINE_string("checkpoint_dir", "./checkpoint/UCSD_128_45_45/",
...
def process_frame(s_name, frames_src, sess):
    ...
    print('frame patches :{}\npatches size:{}'.format(len(frame_patches),
                                                      (frame_patches.shape[1], frame_patches.shape[2])))
